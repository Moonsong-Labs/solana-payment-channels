...
use tabs::event_engine::EventDiscriminator;
use tabs::events::{Opened, PayoutRedirected};

fn committed_idl() -> Value {
    serde_json::from_str(include_str!("../idl/tabs.json")).expect("parse committed IDL")
}
