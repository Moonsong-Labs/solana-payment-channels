# Tabs — build + IDL + client automation.

set shell := ["bash", "-uc"]

program_dir   := "program/tabs"
ts_client_dir := "clients/typescript"
program_id    := "CHNLxYvVA28MJP9PrFuDXccuoGXAx7jBacfLEkahyGsX"
idl_file      := program_dir / "idl/tabs.json"
raw_idl_file  := program_dir / "idl/tabs.raw.json"
...
# deploying, e.g. `solana program deploy target/deploy/tabs.so
...
# print the executable hash. The resulting target/deploy/tabs.so is
